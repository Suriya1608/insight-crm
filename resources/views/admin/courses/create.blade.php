...
@section('content')
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h2 class="page-header-title mb-0">Add Course</h2>
            <p class="page-header-subtitle mb-0">Create a new course for leads and campaigns</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.courses.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name') }}" placeholder="e.g. Bachelor of Computer Applications">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                    value="{{ old('code') }}" placeholder="e.g. BCA" style="max-width:160px;">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" rows="3"
                    placeholder="Optional details about this course">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <span class="material-icons me-1" style="font-size:16px;">save</span>Save Course
                </button>
