...
@section('content')
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h2 class="page-header-title mb-0">Edit Service</h2>
            <p class="page-header-subtitle mb-0">{{ $service->name }}</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name', $service->name) }}" placeholder="e.g. Social Media Management">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                    value="{{ old('code', $service->code) }}" placeholder="e.g. SMM" style="max-width:160px;">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" rows="3"
                    placeholder="Optional details about this service">{{ old('description', $service->description) }}</textarea>
            </div>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <span class="material-icons me-1" style="font-size:16px;">save</span>Update Service
                </button>
