...
@section('content')
        ...
        <div class="d-flex justify-content-between align-items-center w-100 flex-wrap gap-2">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('manager.campaigns.index') }}" class="btn btn-sm btn-light">
                    <span class="material-icons me-1" style="font-size:16px;">arrow_back</span>Campaigns
                </a>
                <div>
    ...
    <div class="chart-card mb-4">
        <form method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-12 col-md-2 d-flex gap-2">
                ...
                <a href="{{ route('manager.campaigns.performance') }}" class="btn btn-light btn-sm">Clear</a>
            </div>
        </form>
    </div>
    ...
    @else
        <div class="chart-card text-center py-5">
            ...
            <p class="text-muted mt-2">No campaigns found. Create a campaign to see performance data.</p>
            <a href="{{ route('manager.campaigns.create') }}" class="btn btn-primary btn-sm mt-2">
                <span class="material-icons me-1" style="font-size:15px;">add</span>Create Campaign
            </a>
        </div>
    @endif
@endsection
